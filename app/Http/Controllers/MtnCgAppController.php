...
class MtnCgAppController extends Controller
{
    ...
    {
        return view("mtn_cg_app.mtn_login_cg");
    }
    ...
    public function validateMtnProfile(Request $request)
    {
        ...
        return view("mtn_cg_app.otp_cg", ['first_name' => $firstName, 'phone_number' => $phone_number]);
    }
    public function generateMtnOtp(Request $request)
    {
        ...
        return view("mtn_cg_app.verify_otp_cg", ['otp_result' => $otp_result, 'phone_number' => $phone_number]);
    }
    ...
    public function validateMtnOtp(Request $request)
    {
        ...
        if ($response) {
            ...
            return view("mtn_cg_app.mtn_success_login_cg", ['response' => $response]);

        } else {
            return view("mtn_cg_app.mtn_failed_login_cg", ['response' => "An error occurred"]);
    ...
    public function makeAccountActive()
    {
        ...
        return view("mtn_cg_app.account_active", ['balance' => $result, 'smebundles' => $result2]);
    }
