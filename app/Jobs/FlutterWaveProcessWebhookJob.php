...
class FlutterWaveProcessWebhookJob extends SpatieProcessWebhookJob
{
    ...
    public function handle()
    {
        ...
        // $response = $payload['eventData']; MONNIFY
        $response = $payload;
        ...
        if ($response['status'] == 'successful') {
            # verify transaction
            $verification = $this->VerifyFlutterwave($response['id']);
            \Log::info("FLUTTERWAVE VERIFICATION");
            ...
            if($verification['status'] == "success"){
                ...
                case "CARD_TRANSACTION":
                    ...
                    $findOrder = Order::where('ref', $response['txRef'])->where('status', 0)->first();
                    ...
                    if (!is_null($findOrder)) {
                        ...
                        if ($subcategory->category_id == 2) {
                        ...
                        } else if ($subcategory->category_id == 1) {
                            //$subcategory =  Subcategory::find($findOrder->subcategory_id);
                            ...
                            if (!is_null($subcategory->description) && $subcategory->description == "SMEPLUG") {
                                ...
                                //$response =  $this->SMEPlugApi($network_id, $plan_id, $phone);
                                //return $this->sendError($response, $response);
                                if ($response['status'] == false || $response['code'] == "424") {
                            ...
                            } else if (!is_null($subcategory->description) && $subcategory->description == "AUTOPILOTAWUF") {
                                ...
                                $response = $this->autoPilotAwuf($network_id,$datatype,$plan_id, $findOrder->phone, $findOrder->ref);
                                \Log::info("From Bank AUTOPILOT");
                                \Log::info($response);
                                //$response =  $this->SMEPlugApi($network_id, $plan_id, $phone);
                                //return $this->sendError($response, $response);
                                if (!isset($response) || is_null($response) || $response['code'] == 201) {
                                    ...
                                    $updateOrder->response = $msg1;
                                    $updateOrder->save();
                                    $msg = $msg1 . " AutoPilotAwuf Ref: " . $response['data']['reference'];
                                ...
                                if (isset($response['data']) && isset($response['data']['transaction']) && $response['data']['transaction']['status'] == "pending"){
                                    ...
                                    \Log::info("it failed AUTOSYNCAWUF");
                                    $updOrder = Order::where('ref', $findOrder->ref)->first();
                                    $updOrder->status = 4;
                                    $updOrder->save();
                                    ...
                                    $this->sendTelegramMessage2($findOrder->user, $findOrder->amount, $findOrder->phone, $subcategory->pins, $getSelectedProduct->variation_code, $findOrder->ref, $subcategory->telegram);
                                    ...
                                    $this->sendTelegramMessage2($findOrder->user, intVal($findOrder->amount), $findOrder->phone, $subcategory->pins, $getSelectedProduct->variation_code, $findOrder->ref, $subcategory->telegram, $msg);
                                }
                            ...
                            if ($this->isCredited($amt, $findUser->id)) {
                                ...
                                $findOrder->bal = $findUser->wallet + $amt;
                                $findOrder->prev_bal = $findUser->wallet;
                        ...
                        if ($subcategory->category_id == 2) {
                            ...
                            if (!is_null($subcategory->description) && $subcategory->description == "SMEPLUG") {
                                ...
                                if (isset($response['data']) && isset($response['data']['transaction']) && $response['data']['transaction']['status'] == "pending"){
                                    ...
                                    \Log::info("it was successful AUTOSYNC From bank");
