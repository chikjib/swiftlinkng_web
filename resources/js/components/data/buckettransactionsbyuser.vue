<template>
    ...
    <div v-else class="row">
      <div class="col-lg-12">
        <h4 class="card-title">User Bucket Transactions</h4>
        <div class="row">
  ...
  export default {
    ...
    methods: {
      ...
      list(page) {
        ...
        this.isloading = true;
        axios
          .get(`/api/bucket-orders?page=${page}&user=${this.$route.params.id}`, {
            headers: {
              Authorization: `Bearer ${token}`,
              "Content-Type": "application/json",
            },
      ...
      getResults(page) {
        ...
        axios
          .get(
            `/api/bucket-orders?search_user=${this.keyword}&field=${this.field}&status=${this.status}&user_id=${this.$route.params.id}&page=${page}`,
            {
              headers: {
                Authorization: `Bearer ${token}`,
                "Content-Type": "application/json",
